...
Consider switching selected dependency-cruiser rules from warning to error now that the measured boundary warnings are clean. Then proceed to error taxonomy and execution result contracts.
