...
Continue converting only high-signal ambiguity points: strategy registry/module loading, remaining ConfigLoader validation groups, and local StateStore invariants that operators or tests need to distinguish.
